...
class getAnnotatedAppEntityReferentielApiPlatformCoreBridgeDoctrineOrmFilterBooleanFilterService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['annotated_app_entity_referentiel_api_platform_core_bridge_doctrine_orm_filter_boolean_filter'] = new \ApiPlatform\Core\Bridge\Doctrine\Orm\Filter\BooleanFilter(($container->services['doctrine'] ?? $container->getDoctrineService()), NULL, ($container->privates['monolog.logger'] ?? $container->load('getMonolog_LoggerService')), ['isDrop' => NULL], ($container->privates['serializer.name_converter.metadata_aware'] ?? $container->getSerializer_NameConverter_MetadataAwareService()));
    }
}
